          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
                <div class="profile_pic">
                    <img src="<?= base_url('assets/images/userav.png'); ?>" alt="..." class="img-circle profile_img">
                </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a href="<?= base_url('admin/dashboard'); ?>"><i class="fa fa-tachometer"></i> Dashboard </a></li>
                  <?php if($this->session->userdata('type') == "admin" ) : ?>
                  <li><a><i class="fa fa-user"></i> Employee Section <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('admin/employee/add'); ?>">Add Employees</a></li>
                      <li><a href="<?= base_url('admin/employee'); ?>">Manage Employees</a></li>
                    </ul>
                  </li>
                  
                    <li>
                        <a><i class="fa fa-th-large"></i>Manufacturer &amp; Model <span class="fa fa-chevron-down"></span></a>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a href="<?php echo base_url() . 'admin/dashboard/logout'; ?>" data-toggle="tooltip" data-placement="top" title="Logout">
