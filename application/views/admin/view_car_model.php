...
<div class="right_col" role="main">
    <div class="">
        ...
        <!-- add new model -->
        <button type="button" class="btn btn-success" data-toggle="modal" data-target=".add-model">Add New Model</button>
                ...
                <div class="modal-body">
                    <?php echo form_open_multipart('admin/car_model/addModel'); ?>
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-success" name="buttonSubmit" value="Add New Model">
                                </div>
                            </fieldset>         
                        </form>
                </div>
